...
You will learn about visual perception and communication (creation of images) and the relation between them. You will also learn some basic techniques that psychologists use to investigate what people see. 

Lastly, we should also design images ourselves. Because many design students already have quite some sketching experience, and likely used video and photography in previous courses, we will focus on a relatively unexplored technique: sketching with code. Specifically we will use the P5.js, a JavaScript library specifically aimed at artsist and designers. 
...
Below you will find links to P5 video tutorials by the creative coding genius [Daniel Shiffman](https://shiffman.net/). Be aware that some older videos use a different coding interface, you should just do everything in the new [P5 online editor](https://editor.p5js.org). 
